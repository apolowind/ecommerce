        ...
        <Footer style={{ backgroundColor: "#1e0a3c", padding: 30, paddingTop: 80 }}>
            <Row className="footer-desktop">
                ...
                <Col span={5} className="footer">
                    ...
                    <p style={{ marginTop: 20, color: "#FFFFFF", fontWeight: 400, fontSize: 14, cursor: "pointer" }}>Trụ sở : Số 75 Yên Xá, xã Tân Triều, huyện Thanh Trì, Hà Nội</p>
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: 13 }}>Copyright@ 2023 Created by team Mobile Store</p>
